...
class Bartender(Npc):
    ...
    def bt_respond(self, **kwargs):
        self.execute_cmd("say respond called.")
        say = kwargs["say"]
        ...
        if from_obj != self:
            ...
            if is_say:
                ...
                if " [to You]: " in text[0]:
                    ...
                    if response != None:
                        delay(1, self.bt_respond, say=response)
                    else:
                        delay(1, self.bt_respond, say="Sorry, I couldn't hear you! [OOC: This is an error.]")
